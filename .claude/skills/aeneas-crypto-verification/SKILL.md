...
<!-- Vendored verbatim from AeneasVerif/aeneas documentation/skills/aeneas-crypto-verification.instructions.md
     at commit 864eddb4876d0104802e0fd29bd453f67f48c4be (2026-04-10). Refresh from
     upstream before editing; policy, rationale, and where cross-references to
     non-vendored skills resolve: the skill-authoring skill. -->
